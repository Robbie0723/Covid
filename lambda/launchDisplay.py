...
def launch_page_data_source():
    return  {
    "bodyTemplate7Data": {
        "type": "object",
        "objectId": "bt7Sample",
        "title": "Virus Status Updates presented by:",
        "backgroundImage": {
            "sources": [
                {
                    "url": "https://?????????????.s3.amazonaws.com/logo.png",
                    "size": "small",
                    "widthPixels": 0,
                    "heightPixels": 0
                },
        ...
        "hintText": "Try, \"Alexa, what is the virust status updates for the world\""
    }
}